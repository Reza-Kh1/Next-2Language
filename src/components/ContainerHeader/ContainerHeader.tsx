...
export default function ContainerHeader({ light, dark, text, firstDark }: ContainerHeaderType) {
    return (
        <section className="w-full relative h-96">
            ...
            <span className="w-2/4 bg-center absolute left-1/2 top-0 transform -translate-x-1/2 h-full" style={{ backgroundImage: `url(dot-top.png)` }}></span>
