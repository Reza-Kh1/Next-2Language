    ...
    return (
        <>
            ...
            <main className='main-class'>
                <div className='flex w-2/3 gap-3 my-32 mx-auto items-center'>
                    <div className='w-1/5'>
                ...
                <div className='flex gap-10 my-24'>
                    <div>
                ...
                <div className='flex flex-col my-16 gap-10'>
                    <h2 className='text-w-100 text-4xl font-semibold'>Featured Project</h2>
                    <div className='flex items-center gap-7'>
                        ...
                        <div className='flex flex-col gap-8 w-1/2'>
                            ...
                            <span className='text-w-100 text-3xl font-semibold'>Bolder Landingpage</span>
                            <p className='text-w-50'>Serrow restructured and designed core pages, creating interactive elements that put users in control and allowed them to discover the information needed to make a decision.</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-7'>
                        <div className='relative w-1/2'>
                        ...
                        <div className='flex flex-col gap-8 w-1/2'>
                            <span className='text-w-80'>Web Development</span>
                            <span className='text-w-100 text-3xl font-semibold'>Kerja Mantul Education Management</span>
                            <p className='text-w-50'>Serrow restructured and designed core pages, creating interactive elements that put users in control and allowed them to discover the information needed to make a decision.</p>
                        </div>
                    </div>
                    <div className='flex justify-start'>
                        <Link href={"#"} className='text-w-100 flex items-center gap-4 p-3 px-6 border border-d-60 rounded-full '>
                            <HiOutlineMenu />
                            See More
                        </Link>
                    </div>
                ...
                <div>
                    <h2 className='text-w-100 text-4xl font-semibold mb-12'>Code Snippet</h2>
                    <div className='grid grid-cols-2 gap-10'>
                        <div className='p-8 flex justify-between flex-col rounded-xl border border-d-60' style={{ backgroundImage: 'linear-gradient(204deg, #ffffff0d, #0202028f)' }}>
                            <div>
                                <span className='text-2xl text-w-100 font-semibold'>Nextjs Starter</span>
                                <p className='text-w-50 mt-4'>A dead simple for nextjs project.</p>
                            </div>
                        ...
                        <div className='p-8 flex gap-10 justify-between flex-col rounded-xl border border-d-60' style={{ backgroundImage: 'linear-gradient(204deg, #ffffff0d, #0202028f)' }}>
                            <div>
                                <span className='text-2xl text-w-100 font-semibold'>Frontend Starter Kit</span>
                                <p className='text-w-50 mt-4'>AA dead simple for html 5 boilerplate project. Included setup dead simple for html 5 boilerplate project. Included setup for minify css, html minify, SEO setting.</p>
                            </div>
                            <div className='flex items-center justify-between'>
                                <div className='flex gap-4'>
                                    <i className='p-2 rounded-full bg-d-80 border border-d-60 text-w-100'>
                ...
                <div className='my-24'>
                    <h2 className='text-w-100 text-4xl font-semibold mb-6'>Mentorship</h2>
                    <div className='flex gap-7 items-start'>
                        ...
                        <div className='flex flex-col gap-5 w-2/3'>
                            <div className='flex gap-5 p-6 rounded-xl border border-d-60'>
                ...
                <div className='my-24 flex'>
                    <div className='w-1/3'>
                        <h2 className='text-w-100 text-4xl font-semibold mb-6'>Keuntungan Mentorship</h2>
                        <ImageCustom alt={"ex"} src={"/biting.png"} width={300} height={400} />
                    </div>
                    <div className='w-2/3 flex flex-col gap-5'>
                        <div className='relative flex flex-col ml-16 p-8 pl-14 border border-d-60 rounded-xl'>
                            ...
                            <div className="p-4 absolute -left-9 top-1/2 transform -translate-y-1/2 border-1 overflow-hidden rounded-full border-d-50" style={{ background: 'linear-gradient(134deg, #3a3838e6, #000000ed)' }}>
